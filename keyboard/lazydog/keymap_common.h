...
#define KEYMAP( \
    ...
    K40, K41, K42,           K45,           K48, K49, K4A, K4B, K4C, K4D, K4E \
) { \
    ...
    { KC_##K40, KC_##K41, KC_##K42, KC_NO,    KC_NO,    KC_##K45, KC_NO,    KC_NO,    KC_##K48, KC_##K49, KC_##K4A, KC_##K4B, KC_##K4C, KC_##K4D, KC_##K4E}  \
}
